...
import com.willowtreeapps.signinwithapplebutton.SignInWithAppleUser;
...
public class SampleJavaActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        SignInWithAppleCallback callback = new SignInWithAppleCallback() {
            @Override
            public void onSignInWithAppleSuccess(@NotNull String authorizationCode, @NotNull String idToken, SignInWithAppleUser user) {
